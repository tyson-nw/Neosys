...
- I am a braggart that will bite of more than I can chew.
...
| Rapier | 1d6 | [[#Piercing]], [[#Finesse]], [[#Martial]] ||
...
Your class also provides abilities with each tier.
...
You cannot critically fail your [[#Deflect]] or [[#React]] rolls.

### Aware Shield
*Tier 1, Attuned*

While wielding the shield you have [[#Edge]] on initiative checks.
...
The armor does not have the [[#Noisy]] tag.

### Silent Strides
*Tier 1*

The armor does not cause [[#Hinderance]] on [[#Stealth]] rolls.
...
If the target has cast a spell in the last hour, deal an additional 2d6 damage. The target has [[#Hinderance]] on [[#Enigma]] rolls for the next hour.
...
You have [[#Edge]] on your [[#Stabilization Roll]] and are immune to the [[#Bleeding]] condition.
...
You have [[#Expertise]] when moving silently.
...
While wearing the cloak you have [[#Edge]] on [[#Stealth]] rolls.

### Bracers of Archery
_Tier 1, Attunement_

You have [[#Specialties|Expertise]] with bows.
...
You have [[#Specialties|Expertise]] with sight.
...
Can see in low light as if it were daylight.
...
When used you can cast a prepared 1st tier spell without rolling against your burn. You can do this once before a long rest.

### Pipes of Terror
*Tier 1*

Play the pipes as an [[#Act]] to roll [[#Will]]+[[#Knowledge]] as well as any musical [[#Expertise]] against targets [[#Mind]] within 30ft that can hear them are [[#Frightened]] of the player for as long as the pipes play.
...
You have damage resistance and Edge on [[#Body]] defenses for 1 hour.
...
### Lair Acts
These are [[#Deflectts]] that a creature can choose to do within their Lair on [[#Initiative]] 0. They can only choose a single [[#Act]].

## Creating an Encounter.
To determine what is an appropriate encounter, total the tiers of the characters present. Add the [[#Target Number]] of the desired difficulty and subtract 6 for Tier 1 characters, 4 for Tier 2 characters, 2 for Tier 2 characters. That is your challenge budget. Add creatures to the encounter until their total [[#Challenge]] equals your encounter budget.

## Creating a creature
1. Set Size, Type, Tier
2. Assign Stats totaling 3 or less for Tier 1 creatures
3. Calculate Body, React, Mind by totaling stats and adding 6 to each
4. Determine if the creature has armor, natural or otherwise
5. Calculate Deflect and Soak
6. The base HP is, 3, 4, or 5 depending on how martial the creature is and its size. Add the fort modifier. Swarms have a base HP of 10. HP is base HP multiplied by the challenge.
